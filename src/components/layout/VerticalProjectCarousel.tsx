        ...
        {projects.map((project, index) => {
          ...
          return (
            <div
              ...
              onClick={() => openProjectDetails(project, false)}
            >
                ...
                <div className="carousel-item-content">
                  ...
                  <div className="flex items-center justify-center mt-2">
                    <p className="text-xl font-bold flex items-center gap-2">
                      <span className="text-[#0d2c54] whitespace-nowrap overflow-visible">
                        {formatCurrency(project.fundingGoal, project.currencyType || "XLM", false)}
                      </span>
                    </p>
                  </div>
                </div>
