...
interface UsdtLogoProps extends React.SVGProps<SVGSVGElement> {}

export function UsdtLogo({ className, ...props }: UsdtLogoProps) {
  return (
    <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 339.43 295.27" className={cn("h-4 w-4", className)} {...props}>
