 ...
 */
export type GovernedAction = {tag: "Release", values: readonly [ReleaseTerms]} | {tag: "SetOwners", values: readonly [Array<string>]} | {tag: "SetVotingWindow", values: readonly [u64]};
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "",
