...
export interface Client {
  ...
  /**
   * Construct and simulate a settle_stalled transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   ...
   */
  settle_stalled: (options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
  ...
  public readonly fromJSON = {
    initialize: this.txFromJSON<null>,
        ...
        settle_stalled: this.txFromJSON<null>,
