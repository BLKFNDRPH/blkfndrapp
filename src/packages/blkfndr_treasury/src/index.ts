 ...
 */
export type GovernedAction = {tag: "SetFee", values: readonly [i128]} | {tag: "TransferAdmin", values: readonly [string]} | {tag: "SetShareholders", values: readonly [Array<Shareholder>]} | {tag: "SetOwners", values: readonly [Array<string>]};
...
export type DataKey = {tag: "Factory", values: void} | {tag: "Shareholders", values: void} | {tag: "VoteWindow", values: void} | {tag: "NextCycleId", values: void} | {tag: "Cycle", values: readonly [u32]} | {tag: "OpenCycleId", values: void} | {tag: "Reserved", values: readonly [string]} | {tag: "ClaimCount", values: readonly [u32]} | {tag: "LastReleaseAt", values: void} | {tag: "CycleVote", values: readonly [u32, string]} | {tag: "Claimed", values: readonly [u32, string]} | {tag: "Proposal", values: void} | {tag: "NextProposalId", values: void} | {tag: "ProposalVote", values: readonly [u32, string]};
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "",
        ...
        "",
